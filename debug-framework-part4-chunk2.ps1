...
Set-Content -Path "frontend/school-frontend-app/src/examples/RouterDebugExample.js" -Value $implementationExampleContent
...
Set-Content -Path "frontend/school-frontend-app/src/examples/React18Example.js" -Value $react18ExampleContent
...
Set-Content -Path "frontend/school-frontend-app/scripts/implement-diagnostics.js" -Value $diagnosticImplementationContent

# Add the changes to git
git add frontend/school-frontend-app/src/examples/RouterDebugExample.js frontend/school-frontend-app/src/examples/React18Example.js frontend/school-frontend-app/scripts/implement-diagnostics.js
