...
# Create a backup of the current App.js
Copy-Item -Path "frontend/school-frontend-app/src/App.js" -Destination "frontend/school-frontend-app/src/App.js.bak"

# Create a new App.js file with the correct imports
$appJsContent = @'
...
Set-Content -Path "frontend/school-frontend-app/src/App.js" -Value $appJsContent

# Add the changes to git
git add frontend/school-frontend-app/src/App.js

# Commit the changes
git commit -m "Force update App.js to fix duplicate Routes import"

# Push the changes to GitHub
git push

Write-Host "App.js has been force updated and pushed to GitHub."
