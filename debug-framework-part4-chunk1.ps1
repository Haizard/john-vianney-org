...
Set-Content -Path "frontend/school-frontend-app/docs/DEBUGGING_GUIDE.md" -Value $debuggingGuideContent
...
Set-Content -Path "frontend/school-frontend-app/docs/ERROR_299_GUIDE.md" -Value $error299GuideContent

# Add the changes to git
git add frontend/school-frontend-app/docs/DEBUGGING_GUIDE.md frontend/school-frontend-app/docs/ERROR_299_GUIDE.md
